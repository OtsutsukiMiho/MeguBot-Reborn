...
const th = {
	...
	account: {
		...
		noMergeNote: 'รุ่นแรกยังไม่ merge บัญชี Megu ที่ถูกสร้างแยกกัน หากช่องทางนี้อยู่กับอีกบัญชี ระบบจะหยุดก่อนเปลี่ยนข้อมูลใด ๆ',
		linkConflict: 'ช่องทางนี้อยู่กับบัญชี Megu อื่นแล้ว ระบบไม่ได้เชื่อมหรือ merge ข้อมูลใด ๆ',
