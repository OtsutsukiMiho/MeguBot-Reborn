...
const en = {
	...
	account: {
		...
		noMergeNote: 'Version 1 does not merge two existing Megu accounts. If this sign-in already belongs to another account, Megu stops before changing anything.',
		linkConflict: 'That sign-in already belongs to another Megu account. Nothing was linked or merged.',
