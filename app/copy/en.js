...
const en = {
	...
	servers: {
		...
		empty: 'No servers found matching this filter.',
		backToServerList: 'Back to Server List',
		accessForbiddenTitle: 'Access Forbidden',
		accessForbiddenLede: 'You do not have Administrator or Manage Server permissions for this server. Redirecting to server selector...',
		backToServerSelector: 'Back to Server Selector',
		tabs: {
			...
			nicknames: 'Nickname Manager',
			tts: 'Voice TTS Channel',
			honeypot: 'Honeypot',
			automod: 'Auto-Mod',
